...
tags:
  ...
  - cli-tool
  - automation
date: 2025-12-08T07:00:00+08:00
draft: false
---

import { Tabs, TabItem } from '@astrojs/starlight/components';
import { Picture } from 'astro:assets';
import pdfWithToc from '../../../assets/pdf-with-toc.png';
...
<Picture src={pdfWithToc} style="max-height: 300px; width: auto;" formats={['avif', 'webp', 'jpg', 'png']} alt="screenshot of the PDF's table of contents" quality="high" />

## End notes

I am glad I found this tool. Though I only from time to time encounter PDFs that don't have a ToC already, `pdf.tocgen` greatly reduces the time it takes to add a ToC when I need to.

Special thanks to the [author](https://github.com/Krasjet) of the tool and also this [article](https://sspai.com/post/69601). I didn't understand how to use `pdf.tocgen` until I read it.
